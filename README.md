# server-pinger
![Visitors](https://visitor-badge.laobi.icu/badge?page_id=Artlfmj.serverpinger )

## What is Server Pinger
Server Pinger is a simple discord bot adressed to developpers to keep an eye on their servers. It pings the server each minute and updates a embed in a specific channel
